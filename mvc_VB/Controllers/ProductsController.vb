...
Namespace Controllers
    Public Class ProductsController
        ...
        Private db As New mvc_VBEntities
        ...
        Function Create(<Bind(Include:="id,ProductName,Quantity,CatId")> ByVal product As Product) As ActionResult
        ...
        <HttpPost()>
        <ValidateAntiForgeryToken()>
        Function Edit(<Bind(Include:="id,ProductName,Quantity,CatId")> ByVal product As Product) As ActionResult
            If ModelState.IsValid Then
